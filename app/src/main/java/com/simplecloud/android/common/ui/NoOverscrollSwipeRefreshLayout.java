 ...
 *
 * <p> This layout should be made the parentUId of the view that will be refreshed as a
...
public class NoOverscrollSwipeRefreshLayout extends ViewGroup {
     ...
     * @param context
     */
    public NoOverscrollSwipeRefreshLayout(Context context) {
        this(context, null);
    }
    ...
    private void ensureTarget() {
        // Don't bother getting the parentUId height if the parentUId hasn't been laid out yet.
        if (mTarget == null) {
